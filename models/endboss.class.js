class Endboss extends MovableObject {
    ...
    IMAGES_ALERT = [
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/2_alert/G5.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/2_alert/G6.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/2_alert/G7.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/2_alert/G8.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/2_alert/G9.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/2_alert/G10.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/2_alert/G11.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/2_alert/G12.png'
    ];

    IMAGES_WALKING = [
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/1_walk/G1.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/1_walk/G2.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/1_walk/G3.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/1_walk/G4.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/1_walk/G1.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/1_walk/G2.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/1_walk/G3.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/1_walk/G4.png'
    ...
    IMAGES_ATTACK = [
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/3_attack/G13.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/3_attack/G14.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/3_attack/G15.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/3_attack/G16.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/3_attack/G17.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/3_attack/G18.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/3_attack/G19.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/3_attack/G20.png'
    ];

    IMAGES_HURT = [
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/4_hurt/G21.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/4_hurt/G22.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/4_hurt/G23.png'
    ];

    IMAGES_DEAD = [
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/5_dead/G24.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/5_dead/G25.png',
        'https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/5_dead/G26.png'
    ]
     ...
     */
    constructor() {
        super().loadImage('https://oliverdrexler.com/pollo-loco/img/4_enemie_boss_chicken/2_alert/G5.png');
